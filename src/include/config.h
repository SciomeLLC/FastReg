...
public:
     ...
     *
     * This function outputs all current configuration parameters including file paths,
     * thresholds, and covariate settings.
     */
    void print();
...
private:
     ...
     *
     * Retrieves a value associated with the given key and attempts to cast it to the specified type.
     *
    ...
    /**
     * @brief Retrieves the value for a specific configuration key with a default value.
     *
     ...
     *
     * This function checks that all required keys are present in the configuration file.
     * If any required keys are missing, an error message is displayed.
     */
    void validate_keys();
    /**
     ...
     *
     * This function sets default values for certain configuration keys if they are not
     ...
     *
     * Checks that certain arguments like `POI.file.format`, `regression.type`, and
     * `maf_threshold` have valid values, and throws errors if they do not.
     */
    void validate_args();
    /**
     * @brief Validates the covariate configuration settings.
     *
     * This function checks that the number of covariate types, levels, and reference
     * levels matches the number of covariates, and validates covariate standardization.
     *
     ...
     *
     * This function scans the POI file directory for files matching the specified format (e.g., .bed, .h5).
     */
    void get_poi_files();
    /**
