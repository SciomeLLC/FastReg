...
RcppExport SEXP _FastReg_FastRegCpp(SEXP phenotypeSEXP, SEXP regression_typeSEXP, SEXP pvalue_distSEXP, SEXP output_exclude_covarSEXP, SEXP maf_thresholdSEXP, SEXP hwe_thresholdSEXP, SEXP no_interceptSEXP, SEXP colinearity_rsqSEXP, SEXP poi_block_sizeSEXP, SEXP max_iterSEXP, SEXP rel_conv_toleranceSEXP, SEXP abs_conv_tolderanceSEXP, SEXP max_openmp_threadsSEXP, SEXP pheno_fileSEXP, SEXP pheno_rowname_colsSEXP, SEXP pheno_file_delimSEXP, SEXP covar_fileSEXP, SEXP covar_rowname_colsSEXP, SEXP covar_file_delimSEXP, SEXP poi_file_dirSEXP, SEXP poi_file_delimSEXP, SEXP poi_file_formatSEXP, SEXP poi_typeSEXP, SEXP poi_effect_typeSEXP, SEXP covariatesSEXP, SEXP covariate_typeSEXP, SEXP covariate_standardizeSEXP, SEXP covariate_levelsSEXP, SEXP covariate_ref_levelSEXP, SEXP POI_covar_interactions_strSEXP, SEXP split_by_strSEXP, SEXP output_dirSEXP, SEXP compress_resultsSEXP, SEXP max_blas_threadsSEXP, SEXP max_workersSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_FastReg_FastRegCpp", (DL_FUNC) &_FastReg_FastRegCpp, 35},
    {NULL, NULL, 0}
};
