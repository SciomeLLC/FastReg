...
prefix <- "test";
covar.file <- paste(prefix, ".covar.text");
num.pheno.file <- paste(prefix, ".num.pheno.txt");
bin.pheno.file <-  paste(prefix, ".bin.pheno.txt");
poi.file <-  paste(prefix, ".poi.h5");
poi.subset.file <-  paste(prefix, ".poi.subset.txt");
subject.subset.file <-  paste(prefix, ".sample.subset.txt");
