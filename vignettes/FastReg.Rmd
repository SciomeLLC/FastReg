...
-   **pheno.rownames.cols** - column to be treated as the subject identifier when matching across files. Can be multiple columns (comma separated).
...
-   **POI.type** - genotype\|numerical (dosage value data type)
...
install.packages(\"../../FastReg_0.4.15.tar.gz\", repos = NULL, type = \"source\");
