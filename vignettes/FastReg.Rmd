...
-   **POI.type** - genotype\|dosage (dosage value data type)
...
-   **max.iter** - max iterations for logistic regression. Default - 6

-   **max.threads (optional)** - max number of threads to use
...
install.packages(\"../../FastReg_0.4.11.tar.gz\", repos = NULL, type = \"source\");
